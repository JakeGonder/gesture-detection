...
if conf_dict["mode"] == "live":
    from config_live import INFERENCE_MIN_WRIST_VISIBILITY_THRESHOLD, INFERENCE_MIN_SHOULDER_DISTANCE_TO_ARM_LENGTH_RATIO
else:
    from config_eval import INFERENCE_MIN_WRIST_VISIBILITY_THRESHOLD, INFERENCE_MIN_SHOULDER_DISTANCE_TO_ARM_LENGTH_RATIO
